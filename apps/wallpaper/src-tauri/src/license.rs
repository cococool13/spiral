//! Whop license commands for Wallpaper.

use spiral_license::{self, AppId, LicenseError};
use tauri::AppHandle;

const APP: AppId = AppId::Wallpaper;

fn validator_url() -> String {
    std::env::var("SPIRAL_LICENSE_URL").unwrap_or_else(|_| spiral_license::DEFAULT_VALIDATOR_URL.into())
}
