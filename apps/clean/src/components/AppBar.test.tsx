...
//
// This app sets the environment per file rather than globally; the bar is a
// component, so it needs a document.
...
// This app does not run Vitest with globals, so nothing unmounts the previous
// render for us.
afterEach(cleanup);
